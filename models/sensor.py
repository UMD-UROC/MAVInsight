...
class Gimbal(Sensor):
    ...
    def __init__(self):
        ...
        if self.has_parameter('msg_schema'):
            self.msg_schema = (
                self.get_parameter('msg_schema').get_parameter_value().string_value.lower()
            )
        else:
        ...
        if self.has_parameter('orientation_topic'):
            self.ORIENTATION_TOPIC = (
                self.get_parameter('orientation_topic').get_parameter_value().string_value
            )
        else:
        ...
        if self.has_parameter('body_orientation_topic'):
            self.BODY_TOPIC = (
                self.get_parameter('body_orientation_topic').get_parameter_value().string_value
            )
        else:
