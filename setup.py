...
vehicle_configs = [
    f for f in glob(os.path.join('vehicles', '**/*'), recursive=True) if os.path.isfile(f)
]
sensor_configs = [
    f for f in glob(os.path.join('sensors', '**/*'), recursive=True) if os.path.isfile(f)
]
resource_configs = [
    f for f in glob(os.path.join('resource', '**/*'), recursive=True) if os.path.isfile(f)
]
site_configs = [
    f for f in glob(os.path.join('sites', '**/**'), recursive=True) if os.path.isfile(f)
]
